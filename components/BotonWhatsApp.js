        ...
        {showMenu && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-800">¿En qué te podemos ayudar?</h3>
              <button
            ...
            <div className="space-y-2">
              {mensajesPredefinidos.map((item, index) => (
                <motion.button
                  ...
                  className="w-full text-left p-3 rounded-lg hover:bg-green-50 border border-gray-100 hover:border-green-200 transition duration-200 group"
                >
                  <div className="flex items-center">
                    <FaComment className="w-4 h-4 text-green-500 mr-3 group-hover:scale-110 transition duration-200" />
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <button
                ...
                className="w-full bg-green-500 hover:bg-green-600 text-white py-3 px-4 rounded-lg font-medium flex items-center justify-center space-x-2 transition duration-300"
              >
